    ...
    <div class="form-group">
        ...
        <input id="name" name="name" type="text" class="form-control" value="@if(isset($getUser->name)) {{$getUser->name}} @endif" required>
    </div>
    <div class="form-group">
        <label for="surname">Surname</label>
        <input id="surname" name="surname" type="text" class="form-control" value="@if(isset($getUser->surname)) {{$getUser->surname}} @endif" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input id="email" name="email" type="email" class="form-control" value="@if(isset($getUser->email)) {{$getUser->email}} @endif" required>
    </div>
    <div class="form-group">
